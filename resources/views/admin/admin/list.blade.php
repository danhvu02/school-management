                    ...
                    @foreach ($data['getRecord'] as $value)
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="#" class="btn btn-danger delete-admin" data-toggle="modal" data-target="#deleteModal" data-id="{{ $value->id }}">Delete</a>
                            </td>
                        </tr>
                    @endforeach
                  </tbody>
...
<script>
    $(document).ready(function () {
        $('.delete-admin').click(function () {
            var id = $(this).data('id');
            var url = "{{ route('admin.delete', ':id') }}".replace(':id', id);
